...
async function cloneCollection(sourceCollectionName, targetCollectionName) {
    try {
        ...
        const targetCollectionExists = collections.some((collection) => collection.name === targetCollectionName);
        ...
        console.log(`Collection '${sourceCollectionName}' cloned to '${targetCollectionName}'`);
    }
    catch (error) {
